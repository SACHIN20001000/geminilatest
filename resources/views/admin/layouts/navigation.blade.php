...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{route('users.index',['id'=> 0])}}" data-bs-toggle="slide" href="#">
                ...
                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 256">
                        <g transform="translate(256 0) scale(-1 1)">
                            <g id="galaSettings0" fill="none" stroke="currentColor" stroke-dasharray="none" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="4" stroke-opacity="1" stroke-width="16">
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('leads.index',['id'=> 1]) }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g transform="translate(24 0) scale(-1 1)">
                            <path fill="currentColor" d="M10 4c2.2 0 4 1.8 4 4s-1.8 4-4 4s-4-1.8-4-4s1.8-4 4-4m7 17l1.8 1.77c.5.5 1.2.1 1.2-.49V18l2.8-3.4A1 1 0 0 0 22 13h-7c-.8 0-1.3 1-.8 1.6L17 18v3m-2-2.3l-2.3-2.8c-.4-.5-.6-1.1-.6-1.7c-.7-.2-1.4-.2-2.1-.2c-4.4 0-8 1.8-8 4v2h13v-1.3Z" />
                        </g>
                    </svg>
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide">
                    ...
                    <span class="side-menu__label">Policy (<?php echo new_policy() ?>)</span></a>
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('endrosment.index') }}">
