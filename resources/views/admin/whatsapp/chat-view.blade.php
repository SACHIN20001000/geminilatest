         ...
         @foreach($messages as $message)
                ...
                @if($message->from_user==$user->id)
                 ...
                 <li class="message-item friend">
                  <img src="{{(isset($message->fromUser->profile) && !empty($message->fromUser->profile))? $message->fromUser->profile : url('https://via.placeholder.com/37x37') }}" class="img-xs rounded-circle" alt="avatar">
                  <div class="content">
                    <div class="message">
                      <div class="bubble">
                        <p>{{$message->message}}</p>
              ...
              <div class="d-flex justify-content-between">
                <div class="d-flex align-items-center">
                  ...
                  <figure class="mb-0 me-2">
                    <img src="{{(isset($user->profile) && !empty($user->profile))? $user->profile : url('https://via.placeholder.com/37x37') }}" class="img-sm rounded-circle" alt="image">
